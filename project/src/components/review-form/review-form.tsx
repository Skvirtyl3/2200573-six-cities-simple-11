...
function ReviewForm({offerId}:ReviewFormProp) : JSX.Element
{
  ...
  return(
    <form className="reviews__form form" action="#" method="post" onSubmit={handleFormSubmit}>
      ...
      <textarea value={formData.review} onChange={handleFieldChange} disabled={isMessageSending} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
