...
function ReviewStar({star, checked, disabled, handleFieldChange}:StarReviewProp) : JSX.Element
{
  ...
  return(
    <Fragment>
      <input className="form__rating-input visually-hidden" name="rating"
        onChange={handleFieldChange} value={star.value} id={numberStars} type="radio" checked={star.value === checked} disabled={disabled}
      />
